...
To run this project dashboard first open and run the whole code of each file in Vs Code and then open browser and copy this adddress and paste it on the browser
http://127.0.0.1:8504
---
